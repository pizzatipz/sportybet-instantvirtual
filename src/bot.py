              ...
              try:
                ...
                if fixtures:
                    ...
                    if place_bets:
                        ...
                        # NOTE: HT/FT detail-page odds scraping DISABLED.
                        # Opening 77 fixture detail pages destabilizes Chromium headless,
                        # causing crashes and stale bets. 52K HT/FT odds + 1.3M market_odds
                        # already collected from earlier runs. Match results (the primary
                        # data) are stable without this feature.
